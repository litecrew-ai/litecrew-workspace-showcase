...
- **operate-internet-archaeology-blog** (active, opened 2026-08-29): operate The
  Dead Web Gazette on a recurring cadence. SC 0/3. Next: cadence decision (cron /
  CI / scheduled activations — needs a user call), then discovery enrichment.
- **internet-archaeology-blog** (completed 2026-08-29, archived): built the
  ...
  site; verifier 286 checks. Live asset: `artifacts/writing/internet-archaeology-blog/`.
